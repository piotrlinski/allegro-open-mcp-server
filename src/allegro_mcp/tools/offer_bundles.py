...
def create_offer_bundle_using_post(
...
@mcp.tool
@allegro_call
def list_sellers_offer_bundles_using_get(
...
@mcp.tool
@allegro_call
def get_offer_bundle_using_get(*, bundleId: str) -> dict[str, Any] | ErrorResponse:
    """Get bundle by ID
...
@allegro_call
@requires_writes_enabled
def delete_offer_bundle_using_get(*, bundleId: str) -> dict[str, Any] | ErrorResponse:
    """Delete bundle by ID
...
@allegro_call
@requires_writes_enabled
def update_offer_bundle_discount_using_put(
