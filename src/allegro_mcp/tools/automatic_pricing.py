...
@mcp.tool
@allegro_call
def get_automatic_pricing_rules() -> dict[str, Any] | ErrorResponse:
...
@mcp.tool
@allegro_call
def get_automatic_pricing_rule_by_id(*, ruleId: str) -> dict[str, Any] | ErrorResponse:
...
@allegro_call
@requires_writes_enabled
def delete_automatic_pricing_rule(*, ruleId: str) -> dict[str, Any] | ErrorResponse:
...
@mcp.tool
@allegro_call
def get_automatic_pricing_rules_for_offer(*, offerId: str) -> dict[str, Any] | ErrorResponse:
